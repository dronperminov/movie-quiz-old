...
def get_films(user: Optional[dict] = Depends(get_current_user), search_params: FilmsQuery = Depends()) -> Response:
    ...
    content = template.render(
        ...
        search_start_votes=search_params.start_votes if search_params.start_votes else "",
        search_end_votes=search_params.end_votes if search_params.end_votes else "",
